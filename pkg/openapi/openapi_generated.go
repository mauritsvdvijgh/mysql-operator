...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/presslabs/mysql-operator/pkg/apis/mysql/v1alpha1.BackupSpec":       schema_pkg_apis_mysql_v1alpha1_BackupSpec(ref),
		"github.com/presslabs/mysql-operator/pkg/apis/mysql/v1alpha1.BackupStatus":     schema_pkg_apis_mysql_v1alpha1_BackupStatus(ref),
		...
		"github.com/presslabs/mysql-operator/pkg/apis/mysql/v1alpha1.ClusterSpec":      schema_pkg_apis_mysql_v1alpha1_ClusterSpec(ref),
		"github.com/presslabs/mysql-operator/pkg/apis/mysql/v1alpha1.ClusterStatus":    schema_pkg_apis_mysql_v1alpha1_ClusterStatus(ref),
...
func schema_pkg_apis_mysql_v1alpha1_BackupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"backupUri": {
						SchemaProps: spec.SchemaProps{
							Description: "BucketUri a fully specified bucket URI where to put backup. Default is used the one specified in cluster. optional",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"backupSecretName": {
						SchemaProps: spec.SchemaProps{
							Description: "BackupSecretName the name of secrets that contains the credentials to access the bucket. Default is used the secret specified in cluster. optinal",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_mysql_v1alpha1_BackupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
				...
				Required: []string{"completed", "conditions"},
			},
		},
		Dependencies: []string{
...
func schema_pkg_apis_mysql_v1alpha1_ClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"secretName": {
						SchemaProps: spec.SchemaProps{
							Description: "The secret name that contains connection information to initialize database, like USER, PASSWORD, ROOT_PASSWORD and so on This secret will be updated with DB_CONNECT_URL and some more configs. Can be specified partially Defaults is <name>-db-credentials (with random values)",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_mysql_v1alpha1_ClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
...
func schema_pkg_apis_mysql_v1alpha1_MysqlBackup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/presslabs/mysql-operator/pkg/apis/mysql/v1alpha1.BackupSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/presslabs/mysql-operator/pkg/apis/mysql/v1alpha1.BackupSpec"},
	}
}
...
func schema_pkg_apis_mysql_v1alpha1_MysqlCluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/presslabs/mysql-operator/pkg/apis/mysql/v1alpha1.ClusterSpec"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"github.com/presslabs/mysql-operator/pkg/apis/mysql/v1alpha1.ClusterSpec"},
	}
}
